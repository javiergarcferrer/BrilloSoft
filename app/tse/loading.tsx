...
/**
 * La silueta de las sentencias del Tribunal Superior Electoral: la banda de
 * tinta con sus cuatro cifras, la tarjeta de los años (chips y el mando de los
 * anteriores), el buscador con su alcance y el listado —número y antigüedad,
 * el «relativo a» en varios renglones, el expediente—. Un año con varias
 * páginas en el visor tarda unos segundos la primera vez; lo que llega cae en
 * su sitio.
 */
