      ...
      <div className="space-y-4">
        <Fuente nombre="DGCP — Compras públicas" estado="activa" etiqueta="Conectada">
          ...
          <p className="mt-2">
            ...
            monto, la respuesta se arma recorriendo hasta 6.000 registros del
            rango pedido. Ese conteo es entonces <strong>una muestra</strong>, y
            el buscador lo dice junto al número en vez de presentarlo como el
            censo.
          </p>
          <p className="mt-2">
